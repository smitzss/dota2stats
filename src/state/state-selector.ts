...
export const playersSelector = (state: State) => gameStateSelector(state)?.draft;
...
export const heroLvLSelector = (state: State) => heroSelector(state)?.level;
...
// export const LVLSelector = createSelector(
//   heroLvLSelector,
//   (state) => heroSelector(state)?.level
// );
